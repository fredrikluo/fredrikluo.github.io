...
return isHome;},PGLS:function(){return getMeta("stencil")||"";},ZT:function(){var zt=getMeta('subjectid');zt.replace(",",".");zt.replace(";",",");return escape(zt);},mediaType:function(){return getMeta("mediaid")||"";},domCount:function(){return doc.getElementsByTagName("*").length||"";},iframeCount:function(){return doc.getElementsByTagName("iframe").length;},onloadTime:onloadTime,readyTime:readyTime,webUrl:webUrl,ch:function(){if(window.__docConfig){return __docConfig.__domain;}
...
addLoadEvent(function(){if(typeof window.getUserInfo==='function'){window.getUserInfo(function(re){if(re&&re.uid){sudaLogInit(re.uid);}else{sudaLogInit();}},true);}else{sudaLogInit();}});})();